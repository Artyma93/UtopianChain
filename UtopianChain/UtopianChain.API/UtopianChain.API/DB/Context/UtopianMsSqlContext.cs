...
namespace UtopianChain.API.DB.Context
{
    class UtopianMsSqlContextFactory : IDesignTimeDbContextFactory<UtopianMsSqlContext>
    {
        ...
        string conectWork = @"Server=(localdb)\mssqllocaldb;AttachDbFileName=D:\AAA\Max\UtopianChain\UtopianChain\UtopianChain.API.DB\UtopianDB.mdf;Database=UtopianDB;Trusted_Connection=True";
