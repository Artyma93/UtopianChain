...
import { varThemeConfig } from "../../../utils/theme/theme";
import {
  darkThemeConfigForMakeVar,
  lightThemeConfigForMakeVar,
} from "../../../utils/theme/theme";
  ...
  return (
    <>
      <AppBar position="fixed" color="inherit">
        <Toolbar>
          {/* Очерчиваем внутри края */}
          <Container fixed>
            {/* Компонент контейнер, с помощью которого делим пополам */}
            <Grid
              container
              direction="row"
              justify="center"
              alignItems="center"
            >
              {/* Компонент, с помощью которого распределяем правую часть */}
              <Grid item xs={6}>
                <Grid
                  container
                  direction="row"
